...
public class WriteScheduleFragmenthalf extends Fragment implements View.OnClickListener,DialogInterface.OnDismissListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(view == null)
        {
            ...
            view = inflater.inflate(R.layout.fragment_writeschedulehalf,container,false);
            ...
            LogUtil.d("ssssssssssssssssssssss"+startDay);
    ...
    public void onClick(View view) {
        ...
        if(week==2) {
            switch (view.getId()) {
                ...
                case R.id.textView15:
                    if (!flag15) {
                        timeTextViewClickEventArray2CheckTrue(126,133);
                        flag15 = true;
                    } else {
                        timeTextViewClickEventArray2CheckFalse(126,133);
                        flag15 = false;
                    }
                    adapter.notifyDataSetChanged();
                    break;
                case R.id.textView15half:
                    if (!flag15half) {
                        timeTextViewClickEventArray2CheckTrue(133,140);
                        flag15half = true;
                    } else {
                        timeTextViewClickEventArray2CheckFalse(133,140);
                        flag15half = false;
                    }
                    adapter.notifyDataSetChanged();
                    break;
                case R.id.textView16:
                    if (!flag16) {
                        timeTextViewClickEventArray2CheckTrue(140,147);
                        flag16 = true;
                    } else {
                        timeTextViewClickEventArray2CheckFalse(140,147);
                        flag16 = false;
                    }
                    adapter.notifyDataSetChanged();
                    break;
                case R.id.textView16half:
                    if (!flag16half) {
                        timeTextViewClickEventArray2CheckTrue(147,154);
                        flag16half = true;
                    } else {
                        timeTextViewClickEventArray2CheckFalse(147,154);
                        flag16half = false;
                    }
                    adapter.notifyDataSetChanged();
                    break;
                case R.id.textView17:
                    if (!flag17) {
                        timeTextViewClickEventArray2CheckTrue(154,161);
                        flag17 = true;
                    } else {
                        timeTextViewClickEventArray2CheckFalse(154,161);
                        flag17 = false;
                ...
                case R.id.textView17half:
                    if (!flag17half) {
                        timeTextViewClickEventArray2CheckTrue(161,168);
                        flag17half = true;
                    } else {
                        timeTextViewClickEventArray2CheckFalse(161,168);
                        flag17half = false;
                    }
                    adapter.notifyDataSetChanged();
                    break;
                case R.id.textView18:
                    if (!flag18) {
                        timeTextViewClickEventArray2CheckTrue(168,175);
                        flag18 = true;
                    } else {
                        timeTextViewClickEventArray2CheckFalse(168,175);
                        flag18 = false;
                    }
                    adapter.notifyDataSetChanged();
                    break;
                case R.id.textView18half:
                    if (!flag18half) {
                        timeTextViewClickEventArray2CheckTrue(175,182);
                        flag18half = true;
                    } else {
                        timeTextViewClickEventArray2CheckFalse(175,182);
                        flag18half = false;
                    }
                    adapter.notifyDataSetChanged();
                    break;
                case R.id.textView19:
                    if (!flag19) {
                        timeTextViewClickEventArray2CheckTrue(182,189);
                        flag19 = true;
                    } else {
                        timeTextViewClickEventArray2CheckFalse(182,189);
                        flag19 = false;
                ...
                case R.id.textView19half:
                    if (!flag19half) {
                        timeTextViewClickEventArray2CheckTrue(189,196);
                        flag19half = true;
                    } else {
                        timeTextViewClickEventArray2CheckFalse(189,196);
                        flag19half = false;
                    }
                    adapter.notifyDataSetChanged();
                    break;
                case R.id.textView20:
                    if (!flag20) {
                        timeTextViewClickEventArray2CheckTrue(196,203);
                        flag20 = true;
                    } else {
                        timeTextViewClickEventArray2CheckFalse(196,203);
                        flag20 = false;
                    }
                    adapter.notifyDataSetChanged();
                    break;
                case R.id.textView20half:
                    if (!flag20half) {
                        timeTextViewClickEventArray2CheckTrue(203,210);
                        flag20half = true;
                    } else {
                        timeTextViewClickEventArray2CheckFalse(203,210);
                        flag20half = false;
                    }
                    adapter.notifyDataSetChanged();
                    break;
                case R.id.textView21:
                    if (!flag21) {
                        timeTextViewClickEventArray2CheckTrue(210,217);
                        flag21 = true;
                    } else {
                        timeTextViewClickEventArray2CheckFalse(210,217);
                        flag21 = false;
                    }
                    adapter.notifyDataSetChanged();
                    break;
                case R.id.textView21half:
                    if (!flag21half) {
                        timeTextViewClickEventArray2CheckTrue(217,224);
                        flag21half = true;
                    } else {
                        timeTextViewClickEventArray2CheckFalse(217,224);
                        flag21half = false;
                ...
                case R.id.textView22:
                    if (!flag22) {
                        timeTextViewClickEventArray2CheckTrue(224,231);
                        flag22 = true;
                    } else {
                        timeTextViewClickEventArray2CheckFalse(224,231);
                        flag22 = false;
                    }
                    adapter.notifyDataSetChanged();
                    break;
                case R.id.textView22half:
                    if (!flag22half) {
                        timeTextViewClickEventArray2CheckTrue(231,238);
                        flag22half = true;
                    } else {
                        timeTextViewClickEventArray2CheckFalse(231,238);
                        flag22half = false;
                ...
                case R.id.textView23:
                    if (!flag23) {
                        timeTextViewClickEventArray2CheckTrue(238,245);
                        flag23 = true;
                    } else {
                        flag23 = false;
                        timeTextViewClickEventArray2CheckFalse(238,245);
                    }
                    adapter.notifyDataSetChanged();
                    break;
                case R.id.textView23half:
                    if (!flag23half) {
                        timeTextViewClickEventArray2CheckTrue(245,252);
                        flag23half = true;
                    } else {
                        timeTextViewClickEventArray2CheckFalse(245,252);
                        flag23half = false;
        ...
        if(week==1) {switch (view.getId()) {
            ...
            case R.id.textView15:
                if (!flag15) {
                    timeTextViewClickEventArray1CheckTrue(126,133);
                    flag15 = true;
                } else {
                    timeTextViewClickEventArray1CheckFalse(126,133);
                    flag15 = false;
                }
                adapter.notifyDataSetChanged();
                break;
            case R.id.textView15half:
                if (!flag15half) {
                    timeTextViewClickEventArray1CheckTrue(133,140);
                    flag15half = true;
                } else {
                    timeTextViewClickEventArray1CheckFalse(133,140);
                    flag15half = false;
                }
                adapter.notifyDataSetChanged();
                break;
            case R.id.textView16:
                if (!flag16) {
                    timeTextViewClickEventArray1CheckTrue(140,147);
                    flag16 = true;
                } else {
                    timeTextViewClickEventArray1CheckFalse(140,147);
                    flag16 = false;
                }
                adapter.notifyDataSetChanged();
                break;
            case R.id.textView16half:
                if (!flag16half) {
                    timeTextViewClickEventArray1CheckTrue(147,154);
                    flag16half = true;
                } else {
                    timeTextViewClickEventArray1CheckFalse(147,154);
                    flag16half = false;
                }
                adapter.notifyDataSetChanged();
                break;
            case R.id.textView17:
                if (!flag17) {
                    timeTextViewClickEventArray1CheckTrue(154,161);
                    flag17 = true;
                } else {
                    timeTextViewClickEventArray1CheckFalse(154,161);
                    flag17 = false;
            ...
            case R.id.textView17half:
                if (!flag17half) {
                    timeTextViewClickEventArray1CheckTrue(161,168);
                    flag17half = true;
                } else {
                    timeTextViewClickEventArray1CheckFalse(161,168);
                    flag17half = false;
                }
                adapter.notifyDataSetChanged();
                break;
            case R.id.textView18:
                if (!flag18) {
                    timeTextViewClickEventArray1CheckTrue(168,175);
                    flag18 = true;
                } else {
                    timeTextViewClickEventArray1CheckFalse(168,175);
                    flag18 = false;
                }
                adapter.notifyDataSetChanged();
                break;
            case R.id.textView18half:
                if (!flag18half) {
                    timeTextViewClickEventArray1CheckTrue(175,182);
                    flag18half = true;
                } else {
                    timeTextViewClickEventArray1CheckFalse(175,182);
                    flag18half = false;
                }
                adapter.notifyDataSetChanged();
                break;
            case R.id.textView19:
                if (!flag19) {
                    timeTextViewClickEventArray1CheckTrue(182,189);
                    flag19 = true;
                } else {
                    timeTextViewClickEventArray1CheckFalse(182,189);
                    flag19 = false;
            ...
            case R.id.textView19half:
                if (!flag19half) {
                    timeTextViewClickEventArray1CheckTrue(189,196);
                    flag19half = true;
                } else {
                    timeTextViewClickEventArray1CheckFalse(189,196);
                    flag19half = false;
                }
                adapter.notifyDataSetChanged();
                break;
            case R.id.textView20:
                if (!flag20) {
                    timeTextViewClickEventArray1CheckTrue(196,203);
                    flag20 = true;
                } else {
                    timeTextViewClickEventArray1CheckFalse(196,203);
                    flag20 = false;
                }
                adapter.notifyDataSetChanged();
                break;
            case R.id.textView20half:
                if (!flag20half) {
                    timeTextViewClickEventArray1CheckTrue(203,210);
                    flag20half = true;
                } else {
                    timeTextViewClickEventArray1CheckFalse(203,210);
                    flag20half = false;
                }
                adapter.notifyDataSetChanged();
                break;
            case R.id.textView21:
                if (!flag21) {
                    timeTextViewClickEventArray1CheckTrue(210,217);
                    flag21 = true;
                } else {
                    timeTextViewClickEventArray1CheckFalse(210,217);
                    flag21 = false;
                }
                adapter.notifyDataSetChanged();
                break;
            case R.id.textView21half:
                if (!flag21half) {
                    timeTextViewClickEventArray1CheckTrue(217,224);
                    flag21half = true;
                } else {
                    timeTextViewClickEventArray1CheckFalse(217,224);
                    flag21half = false;
            ...
            case R.id.textView22:
                if (!flag22) {
                    timeTextViewClickEventArray1CheckTrue(224,231);
                    flag22 = true;
                } else {
                    timeTextViewClickEventArray1CheckFalse(224,231);
                    flag22 = false;
                }
                adapter.notifyDataSetChanged();
                break;
            case R.id.textView22half:
                if (!flag22half) {
                    timeTextViewClickEventArray1CheckTrue(231,238);
                    flag22half = true;
                } else {
                    timeTextViewClickEventArray1CheckFalse(231,238);
                    flag22half = false;
            ...
            case R.id.textView23:
                if (!flag23) {
                    timeTextViewClickEventArray1CheckTrue(238,245);
                    flag23 = true;
                } else {
                    flag23 = false;
                    timeTextViewClickEventArray1CheckFalse(238,245);
                }
                adapter.notifyDataSetChanged();
                break;
            case R.id.textView23half:
                if (!flag23half) {
                    timeTextViewClickEventArray1CheckTrue(245,252);
                    flag23half = true;
                } else {
                    timeTextViewClickEventArray1CheckFalse(245,252);
                    flag23half = false;
                                ...
                                public void onClick(DialogInterface dialogInterface, int position) {
                                    switch (position)
                                    {
                                        case 0:
                                            ...
                                            dialog.setOnDismissListener(WriteScheduleFragmenthalf.this);
                                            dialog.show();
                                            break;
                                        case 1:
                                            for (int i = 0; i < 252; i++) {

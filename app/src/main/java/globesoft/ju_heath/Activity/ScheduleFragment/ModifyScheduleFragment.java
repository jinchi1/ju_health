...
public class ModifyScheduleFragment extends Fragment implements View.OnClickListener, DialogInterface.OnDismissListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.fragment_modifyschedule, container, false);
                            ...
                            public void onClick(DialogInterface dialogInterface, int position) {
                                switch (position) {
                                    case 0:
                                        ...
                                        dialog.setOnDismissListener(ModifyScheduleFragment.this);
                                        dialog.show();
                                        break;
                                    case 1:
                                        for (int i = 0; i < 126; i++) {
